...
That analysis must re-read live canonical GitHub/repository truth and determine the earliest unmet dependency inside the remaining O4 product path. Numbering, roadmap order, stale PRs, donor material, planning order, or prior chat state cannot create implementation authority.
