...
This document is the current Kodac engineering roadmap authority after K2 canonical closeout, canonical adoption and bounded closeout of K3-R1 through K3-R6, and canonical adoption of the separately authorized bounded KRI-R1 through KRI-R4 slices. KRI-P0 remains the planning/contract-design authority from which those later, narrower implementation gates were separately authorized.
