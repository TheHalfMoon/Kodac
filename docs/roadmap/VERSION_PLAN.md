...
K4    — ecosystem compatibility & capability registry; canonical R1 plus gate-controlled R2, which becomes canonical only after its exact evidence merge gate passes
