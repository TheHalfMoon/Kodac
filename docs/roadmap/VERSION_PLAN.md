...
The only active mutation unit is the exact documentation-only P7-R16 current-view reconciliation authorized by PR #418 / proof `5562358271`:
...
No sixth path is authorized. The five views may record canonical predecessor facts and the R16 bounded state, but they cannot certify their own closure. Fresh successor-authority analysis is forbidden until guarded merge and mandatory post-merge proof close this reconciliation.
...
All still-effective predecessor P7 non-grants remain effective. Omission from this condensed version view is not authorization, proof, waiver, supersession, or narrowing.
...
Only after the current exact five-view R16 reconciliation independently qualifies, merges guarded, and receives complete post-merge proof may a fresh successor-authority analysis determine whether any later version/program unit is authorized. No later work follows by numbering or composition.
