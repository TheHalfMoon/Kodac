...
The only active mutation unit is the exact documentation-only P7-R15 current-view reconciliation authorized by PR #414 / proof `5562020658`:
...
No sixth path is authorized. The five views may record canonical predecessor facts and the R15 bounded state, but they cannot certify their own closure. Fresh successor-authority analysis is forbidden until guarded merge and mandatory post-merge proof close this reconciliation.

Canonical R15 identities:
...
P7-R15 establishes deterministic supplied-snapshot-to-R14-record-set consistency only. It does not independently prove historical ledger read/bytes/completeness/absence, append history, cryptographic receipt authenticity, policy authorization correctness, historical workspace/Git semantics, verification-engine historical execution, or any lifecycle-completion state.
...
All still-effective canonical P7-R10 through P7-R14 non-grants remain effective. Omission from this condensed version view is not authorization, proof, waiver, supersession, or narrowing.
...
Only after the current exact five-view R15 reconciliation independently qualifies, merges guarded, and receives complete post-merge proof may a fresh successor-authority analysis determine whether any later version/program unit is authorized. No later work follows by numbering or composition.
